...
/*
 ...
 Today you have six topics to review. Once you’ve completed them you can, if you want, go back over the tests from earlier days to improve on your scores.
*/
...
func countLettersInString(mysString str: String){
    print("The string \(str) has \(str.count) letters.")
}

countLettersInString(mysString: "Hello")
...
func getHaterStatusTwo(weather: String) -> String? {
    if weather == "sunny" {
        return nil
    } else {
        return "Hate"
...
func takeHaterActionTwo(status: String) {
    if status == "Hate" {
        print("Hating")
    }
}

if let haterStatus = getHaterStatusTwo(weather: "rainy") {
    takeHaterActionTwo(status: haterStatus)
}
...
func yearAlbumReleasedTwo(name: String) -> Int? {
    if name == "Taylor Swift" { return 2006 }
    if name == "Fearless" { return 2008 }
    if name == "Speak Now" { return 2010 }
    if name == "Red" { return 2012 }
...
var year = yearAlbumReleasedTwo(name: "Red")
...
// let album2 = albumReleased(year: 2006)?.someOptionalValue?.someOtherOptionalValue?.whatever
...
func getHaterStatusThree(weather: String) -> String? {
    if weather == "sunny" {
        return nil
    }else {
        return "Hate"
...
getHaterStatus2(weather: WeatherType2.wind(speed: 11))
...
let felipe = PersonThree(clothes: "Felipe", shoes: "Nike")
felipe.describe()
...
var chayanne = CountrySinger(name: "Chayanne", age: 50)
chayanne.sing()
